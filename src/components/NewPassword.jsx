...
export default function NewPassword() {
  ...
  let validationSchema = Yup.object({
    ...
    newPassword: Yup.string().matches(/^[A-Z][a-z0-9]{5,10}$/, 'failed').required('password is required'),
  })
  ...
  return (
    ...
    <div>
      <h2 className='mt-32 text-xl  '>Reset New Password :</h2>
      ...
      <form className="max-w-md mx-auto text-black" onSubmit={formik.handleSubmit}>
        ...
        <div className="relative z-0 w-full mb-5 group">
          <input type="password" onBlur={formik.handleBlur} onChange={formik.handleChange} value={formik.values.newPassword} id="newPassword" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300  dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
